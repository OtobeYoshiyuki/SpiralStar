...
namespace ArborEditor
{
	...
	internal sealed class AgentControllerInspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			AnimatorGUITools.AnimatorParameterField(animatorController, _MovingParameter, null, EditorGUITools.GetTextContent(_MovingParameter.displayName), AnimatorControllerParameterType.Bool);
			EditorGUILayout.PropertyField(_MovingSpeedThreshold);

			EditorGUILayout.Space();
			EditorGUILayout.LabelField("Speed", EditorStyles.boldLabel);
			AnimatorGUITools.AnimatorParameterField(animatorController, _SpeedParameter, null, EditorGUITools.GetTextContent(_SpeedParameter.displayName), AnimatorControllerParameterType.Float);
			...
			AnimatorGUITools.AnimatorParameterField(animatorController, _MovementXParameter, null, EditorGUITools.GetTextContent(_MovementXParameter.displayName), AnimatorControllerParameterType.Float);
			EditorGUILayout.PropertyField(_MovementXDampTime);

			EditorGUILayout.Space();
			EditorGUILayout.LabelField("MovementY", EditorStyles.boldLabel);
			AnimatorGUITools.AnimatorParameterField(animatorController, _MovementYParameter, null, EditorGUITools.GetTextContent(_MovementYParameter.displayName), AnimatorControllerParameterType.Float);
			EditorGUILayout.PropertyField(_MovementYDampTime);

			EditorGUILayout.Space();
			EditorGUILayout.LabelField("MovementZ", EditorStyles.boldLabel);
			AnimatorGUITools.AnimatorParameterField(animatorController, _MovementZParameter, null, EditorGUITools.GetTextContent(_MovementZParameter.displayName), AnimatorControllerParameterType.Float);
			EditorGUILayout.PropertyField(_MovementZDampTime);

			EditorGUILayout.Space();
			EditorGUILayout.LabelField("Turn", EditorStyles.boldLabel);
			AnimatorGUITools.AnimatorParameterField(animatorController, _TurnParameter, null, EditorGUITools.GetTextContent(_TurnParameter.displayName), AnimatorControllerParameterType.Float);

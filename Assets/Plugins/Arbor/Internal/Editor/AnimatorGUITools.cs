...
namespace ArborEditor
{
	...
	public static class AnimatorGUITools
	{
		...
		static void AnimatorLayerField(AnimatorController animatorController, FlexibleFieldProperty layerNameProperty)
		{
		...
		{
			AnimatorLayerField(GetAnimatorController(animator), layerNameProperty);
		}
		...
		static void AnimatorStateField(AnimatorController animatorController, FlexibleFieldProperty layerNameProperty, FlexibleFieldProperty stateNameProperty)
		{
		...
		{
			AnimatorStateField(GetAnimatorController(animator), layerNameProperty, stateNameProperty);
		}
		...
		static void AnimatorParameterField(Rect position, AnimatorController animatorController, SerializedProperty nameProperty, SerializedProperty typeProperty, GUIContent label, bool hasType = false, AnimatorControllerParameterType parameterType = AnimatorControllerParameterType.Bool)
		{
			if (animatorController != null)
			{
		...
		{
			AnimatorParameterField(position, GetAnimatorController(animator), nameProperty, typeProperty, label, hasType, parameterType);
		}

		static float GetAnimatorParameterFieldHeight(AnimatorController animatorController, SerializedProperty nameProperty, SerializedProperty typeProperty, bool hasType = false)
		{
			float height = 0.0f;
		...
		{
			return GetAnimatorParameterFieldHeight(GetAnimatorController(animator), nameProperty, typeProperty, hasType);
		}

		static Rect GetAnimatorParameterFieldLayoutRect(AnimatorController animatorController, SerializedProperty nameProperty, SerializedProperty typeProperty, bool hasType = false)
		{
			float height = GetAnimatorParameterFieldHeight(animatorController, nameProperty, typeProperty, hasType);
		...
		public static void AnimatorParameterField(AnimatorController animatorController, SerializedProperty nameProperty, SerializedProperty typeProperty, GUIContent label, AnimatorControllerParameterType parameterType)
		{
			Rect position = GetAnimatorParameterFieldLayoutRect(animatorController, nameProperty, typeProperty, true);

			AnimatorParameterField(position, animatorController, nameProperty, typeProperty, label, true, parameterType);
		}
		...
		{
			AnimatorParameterField(GetAnimatorController(animator), nameProperty, typeProperty, label, parameterType);
		}
	}
}